...
def pruebas():
    ...
    actualizar_persona(id_juan, 'juan carlos perez', "16/04/1988", 32165497, 181)
    assert buscar_persona(id_juan) == (1, 'juan carlos perez', "16/04/1988", 32165497, 181)
    assert actualizar_persona(123, 'nadie', "16/04/1988", 12312312, 181) is False
